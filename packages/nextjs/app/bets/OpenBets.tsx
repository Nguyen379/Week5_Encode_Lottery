        ...
        <div>
          ...
          {isOpenSuccess && (
            <div className="block w-auto">
              <p className="truncate">Bets Opened!</p>
            </div>
          )}
        </div>
...
function OpenCloseButton({ isOpen, onClick }) {
  return (
    <button disabled={isOpen} onClick={onClick} className={`btn btn-primary w-full`}>
      {!isOpen ? "Open Bets for five minutes" : "Bets are open"}
    </button>
  );
}
